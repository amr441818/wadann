    ...
    <div className="bg-primary">
      <Container>
        <div className="flex items-center justify-center">
          <h2 className="unique-h text-[22px] lg:text-3xl  font-bold after:!border-white/50 z-0 text-white mt-10 mb-5 text-center">
          ...
          {counters?.map((item: Counter, index) => (
            ...
            >
              <div className="mb-2 flex items-center justify-center">
                <span className="text-[30px] lg:text-3xl font-bold">{item?.count}+</span>
              </div>
