...
import { getHomePropertyDiscoverData } from "@/lib/serverActions"

import React from "react"

const DiscoverBannder = async ({ locale }: { locale: string }) => {
    const data = await getHomePropertyDiscoverData()
    return (
...
export default DiscoverBannder
