...
const DoorSlider = () => {
  ...
  return (
    <div>
      <Container>
        <div className="w-1/2 mx-auto p-4 space-y-2 mt-32">
          <div className="flex flex-row-reverse items-center justify-center">
            ...
            <Swiper
              ...
              freeMode={true}
              watchSlidesProgress={true}
              className="thumbs-slider [&_.swiper-wrapper]:flex-col w-[100px] bg-red-500"
            >
              {doors.map((door) => (
                <SwiperSlide key={door.id} className="cursor-pointer mb-2">
                  <div className="aspect-[2/3] relative">
                    <Image
                      src={
                        "https://pixlr.com/images/generator/text-to-image.webp"
                      ...
                      height={400}
                      alt={`door`}
                      className="!w-[100px] h-full object-cover rounded-md opacity-60 hover:opacity-100 transition-opacity duration-"
                    />
                  </div>
                </SwiperSlide>
              ))}
