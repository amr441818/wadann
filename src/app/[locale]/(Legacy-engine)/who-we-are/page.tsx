  ...
  return (
    <Container className="mb-10">
      <div >
        ...
        <div className="mt-10">
          <div className="flex ">
            <div className="border-2 border-primary border-dashed border-r-0 w-full pb-14">
              <div className="flex items-center gap-3 bg-bodyColor w-fit px-5 py-2 rounded-lg -translate-y-1/2">
                <span className="w-[50px] h-[50px] rounded-full flex items-center justify-center bg-[#580C31]/20">
                  icon
                </span>
          ...
          <div className="flex ">
            <div className="w-[45%] border-2 border-primary border-dashed border-t-0 border-l-0 border-b-0"></div>
            <div className="  w-[55%] pb-14">
              <div className="flex items-center gap-3 bg-bodyColor w-fit px-5 py-2 rounded-lg -translate-y-1/2">
                <span className="w-[50px] h-[50px] rounded-full flex items-center justify-center bg-[#580C31]/20">
                  icon
                </span>
